...
private boolean validasi(String judul,String penulis){ //mthod agar tidk ada data yang sama ketika dibuat
       try{ //untuk membuat eksepsi
           stt = con.createStatement(); //agar konek db
           String sql = "SELECT * FROM buku where judul='"+judul+"'"+" AND penulis='"+penulis+"'"; //mendeklarasikan variabel sql dengan query untuk menampilkan data sesuai kondisi judul yang ditentukan
...
public boolean HapusData(String id){
    ...
    private void initComponents() {
        ...
        comboPenulis.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Jeon Jungkook", "Kim Taehyung", "Ooh Sehun", "Xi Luhan" }));
    ...
    private void simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanActionPerformed
        ...
        if(validasi(judul,penulis)){
            JOptionPane.showMessageDialog(null, "Data Sudah Ada Man!");
        }else{
            TambahData(judul,penulis,harga);
            InitTable();
            TampilData();
            JOptionPane.showMessageDialog(null, "SELAMAT SUDAH SIMPAN DATANYA");
        TambahData(judul,penulis,harga);
        InitTable();
        TampilData();
